...
import { ArrowLeft, Building2, Users, GraduationCap, UserCheck, Sparkles, Plus } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/6 right-1/4 animate-pulse delay-200">
          <Sparkles className="w-4 h-4 text-white/40" />
        </div>
        <div className="absolute bottom-1/4 left-1/6 animate-pulse delay-800">
          <Sparkles className="w-3 h-3 text-white/30" />
        </div>
        <div className="absolute top-2/3 right-1/3 animate-pulse delay-1200">
      ...
      <div className="relative z-20 w-full max-w-4xl">
        ...
        <div className="bg-white/5 backdrop-blur-3xl rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] border border-white/10 p-10 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-tl from-purple-500/10 via-pink-500/5 to-emerald-500/8 rounded-3xl"></div>
              ...
              <div className="text-center flex flex-col h-full justify-between relative z-10">
                <div>
                  ...
                  <p className="text-slate-600 group-hover:text-white/90 mb-8 leading-relaxed flex-grow transition-colors duration-300">
                    Register your educational institution to set up attendance management systems and onboard students and teachers.
                  </p>
                </div>
            ...
            >
              ...
              <div className="text-center flex flex-col h-full justify-between relative z-10">
                <div>
                  ...
                  <p className="text-slate-600 group-hover:text-white/90 mb-8 leading-relaxed flex-grow transition-colors duration-300">
                    Create your personal account as a student or teacher to join your institution and manage your attendance.
                  </p>
                </div>
                <div className="inline-flex items-center justify-center px-6 py-3 bg-emerald-100 group-hover:bg-white/20 group-hover:backdrop-blur-md group-hover:border group-hover:border-white/30 rounded-full text-emerald-600 group-hover:text-white font-semibold transition-all duration-300 mt-auto group-hover:scale-105 intro-pop intro-delay-3">
                  <span>Register as Student/Teacher</span>
                  <ArrowLeft className="w-5 h-5 ml-2 rotate-180 group-hover:translate-x-1 transition-transform duration-300" />
                </div>
              </div>
            </Link>
          ...
          <div className="text-center mt-8 pt-6 border-t border-white/20 relative z-10">
            ...
            <Link 
              to="/login-selection" 
              className="group inline-flex items-center text-white hover:text-purple-200 font-semibold text-lg transition-all duration-300 hover:scale-105 ml-1"
            >
